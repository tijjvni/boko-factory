<div class="p-5">
    ...
    <nav class="bg-grey-light rounded-md w-full mb-5 text-sm">
        <ol class="list-reset flex">
            ...
            <li><a href="{{ route('config') }}" class="text-indigo-600 hover:text-indigo-700">Users Management</a></li>
            <li><span class="fa fa-chevron-right text-gray-500 mx-2"></span></li>
            <li><a href="{{ route('config.users.suppliers') }}" class="text-indigo-600 hover:text-indigo-700">Suppliers</a></li>
            <li><span class="fa fa-chevron-right text-gray-500 mx-2"></span></li>
            <li class="text-gray-500">Add </li>
        </ol>
    </nav>

    <x-jet-form-section submit="addSupplier">
        <x-slot name="title">
            {{ __('Suppliers') }}
        </x-slot>
        ...
        <x-slot name="form">
            ...
            <fieldset class="col-span-6 rounded shadow-md p-5 pt-2">
                <legend class="m">Supplier</legend>
        ...
        <x-slot name="actions">
            <x-jet-action-message class="mr-3" on="production_started">
                {{ __('Supplier added, you\'ll be redirected now.') }}
