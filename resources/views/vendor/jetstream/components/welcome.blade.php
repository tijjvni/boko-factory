<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        Welcome to management information system for {{ env('APP_NAME') }}
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    <div class="p-6">
        <div class="flex items-center">
            <i class="fa fa-chart-simple fa-2xl text-gray-400"></i>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Stats</a></div>
        </div>

        <div class="ml-10">

            <div class="" >
                <div class="w-full h-full py-8 px-6 space-y-6 rounded-xl border border-gray-200 bg-white">
                    ...
                    <div>
                        ...
                        <div class="mt-2 flex justify-center gap-4">
                            <h3 class="text-lg md:text-2xl font-bold text-gray-700">N32,235,988</h3>
...
<path d="M6.00001 0L12 8H-3.05176e-05L6.00001 0Z" fill="currentColor"/>
                        ...
                        <span class="block text-center text-gray-500">Compared to last week N13,225,988</span>
                    </div>
                </div>
            </div>
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            <i class="fa fa-highlighter fa-2xl text-gray-400"></i>
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Highlights</a></div>
        </div>
